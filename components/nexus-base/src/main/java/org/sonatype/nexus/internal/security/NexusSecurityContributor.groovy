        ...
        roles: [
            ...
            new CRole(
                ...
                privileges: [
					...
					'nx-repository-view-maven2-google-maven-central-browse',
					'nx-repository-view-maven2-google-maven-central-read',
					'nx-repository-view-maven2-jcenter-proxy-browse',
					'nx-repository-view-maven2-jcenter-proxy-read',
					...
					'nx-repository-view-nuget-nuget.org-proxy-browse',
					'nx-repository-view-nuget-nuget.org-proxy-read',
					'nx-repository-view-pypi-pypi-central-browse',
					'nx-repository-view-pypi-pypi-central-read'
                ]
            )
        ]
    )
